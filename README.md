...
7. `pip install git+git://github.com/ITC-Water-Resources/pyaltim/tree/main` Install `pyaltim` (needed for connecting to the Dahiti portal
8. Install additional tools using conda or pip `h5netcdf,folium, cartopy, fftw, ..` (fall back to pip when the package does not have a conda version)
